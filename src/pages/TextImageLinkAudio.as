package src.pages
{
	...
	public class TextImageLinkAudio extends DynamicPageAPI
	{
		...
		public function TextImageLinkAudio()
		{
			super();
		...
		function completeHandler(event:LoaderEvent):void {		  
		  ...
		  if(image)
		  {
				  ...
				  imageURL = currentPageTag.@imageURL
				  image.addEventListener(MouseEvent.CLICK, openURL);
